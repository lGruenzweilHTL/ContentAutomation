...
tk.CTkLabel(master=script_frame, text='Title', font=font_header).pack(pady=20)
title = tk.CTkEntry(master=script_frame, font=font)
title.pack()
tk.CTkLabel(master=script_frame, text='Video Script', font=font_header).pack(pady=20)
